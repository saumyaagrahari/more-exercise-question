...
def report(stamina):
    if stamina > 8:
        print (stamina,"The alien is strong! It resists your pathetic attack!")
    elif stamina > 5:
        print (stamina,"With a loud grunt, the alien stands firm.")
    elif stamina > 3:
        print (stamina,"Your attack seems to be having an effect! The alien stumbles!")
    elif stamina > 0:
        print (stamina,"The alien is certain to fall soon! It staggers and reels!")
    else:
